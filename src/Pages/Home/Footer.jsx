  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/VG-2.png" height ="100px" width="100px" alt="VG" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/vicky.guarav"
            ...
            <li>
              <a
                href="https://www.instagram.com/__vikas_gurav__/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://x.com/VIKASGURAV11106"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
              <svg xmlns="http://www.w3.org/2000/svg" height="31" width="31" viewBox="0 0 512 512"><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg>

              </a>
            </li>
            <li>
              <a
                href="https://www.linkedin.com/in/vikas-gurav/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
